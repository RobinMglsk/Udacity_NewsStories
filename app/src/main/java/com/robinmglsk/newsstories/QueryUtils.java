...
public class QueryUtils {
     ...
     * Query the API.
     */
    public static ArrayList<NewsStory> fetchNewsStories(String requestUrl) {
        ...
        ArrayList<NewsStory> newsStories = jsonToArrayList(jsonResponse);
     ...
     */
    public static ArrayList<NewsStory> jsonToArrayList(String response) {
        ...
        try {
            ...
            JSONArray stories = data.getJSONObject("response").getJSONArray("results");
            ...
            for(int i = 0; i < stories.length(); i++){
                ...
                if(story.has("webPublicationDate")){
                    try {
                        ...
                        Log.e(LOG_TAG, "Problem with parsing the date");
                    }
                }
